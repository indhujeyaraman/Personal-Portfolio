    ...
    <>
      ...
      <main className="flex w-full flex-col items-center justify-center min-h-screen bg-light text-dark">
        ...
        <div className="relative h-full flex  ">
          ...
          <motion.div
      className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-12 md:gap-16 lg:gap-20 xl:gap-24 w-full lg:w-2/3 lg:pr-0 xl:w-1/2 overflow-auto"
    >
      {/* BIOGRAPHY SECTION */}
      <div className="flex flex-col gap-8 justify-center relative">
        ...
        >
          ...
          aliquid magnam expedita, libero dolor iste cumque? Quae possimus magni
          necessitatibus aperiam, natus quibusdam, fugiat, reprehenderit odio
          fugit laboriosam minus nam?
        </motion.p>
        ...
        {[
          ...
          <div className="hidden lg:block lg:w-1/3 xl:w-1/2 relative pt-18">
