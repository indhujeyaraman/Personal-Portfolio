...
import Project5 from "../../public/images/projects/Tic-tac-toe-game.png";
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 max-xl:gap-x-16 max-lg:gap-x-8 max-md:gap-y-24 max-sm:gap-x-0">
            ...
            <div className="col-span-6 max-md:col-span-12">
              ...
              <Project
                ...
                img={Project5}
                link="https://indhujeyaraman.github.io/Tic-Tac-Toe/"
                github="https://github.com/indhujeyaraman/Tic-Tac-Toe"
                type="React Project"
              />
            </div>
          </div>
